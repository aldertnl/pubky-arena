...
describe('PostMain', () => {
  ...
  it('applies wide padding for side tags layout', () => {
    render(<PostMain postId="post-side-1" tagsLayout="side" />);

    const cardContent = screen.getByTestId('card-content');
    expect(cardContent).toHaveAttribute('data-class-name', expect.stringContaining('px-12 py-6'));
  });
  ...
  it('applies default padding for inline tags layout', () => {
    render(<PostMain postId="post-inline-1" tagsLayout="inline" />);

    const cardContent = screen.getByTestId('card-content');
    expect(cardContent).toHaveAttribute('data-class-name', expect.stringContaining('p-6'));
    expect(cardContent).not.toHaveAttribute('data-class-name', expect.stringContaining('px-12'));
  });
