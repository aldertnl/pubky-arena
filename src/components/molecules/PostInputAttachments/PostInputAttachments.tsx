        ...
        {hasExisting || hasNew ? (
          <Atoms.Container className="gap-4">
            ...
            {existingAttachments?.map((a, i) => {
              ...
              return (
                <Atoms.Container key={a.uri} className="relative">
                  <Atoms.Button
                    variant="dark"
                    size="icon"
                  ...
                  {type === 'video' && <Atoms.Video src={a.previewUrl} className="h-48 w-full cursor-auto" />}

                  {type === 'audio' && <Atoms.Audio src={a.previewUrl} className="w-full cursor-auto" />}
