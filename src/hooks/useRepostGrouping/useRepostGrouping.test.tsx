...
// Hoist Core mocks
const { mockFindByIdsPreserveOrder } = vi.hoisted(() => ({
  mockFindByIdsPreserveOrder: vi.fn(),
}));

// Mock Core (PostDetailsModel, PostRelationshipsModel - used when useLiveQuery runs; tests bypass via useLiveQuery mock)
vi.mock('@/core', async () => {
