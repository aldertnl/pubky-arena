...
const translations: Record<string, string> = {
  'dialogs.customFeed.feedCreated': 'Created {name}',
  'dialogs.customFeed.feedEdited': 'Edited {name}',
  'dialogs.customFeed.feedDeleted': 'Deleted {name}',
  'dialogs.customFeed.feedCreateError': 'Could not create feed. Try again.',
  'dialogs.customFeed.feedEditError': 'Could not edit feed. Try again.',
  'dialogs.customFeed.feedDeleteError': 'Could not delete feed. Try again.',
};
...
describe('useCustomFeedForm', () => {
  ...
  describe('submit — create', () => {
    ...
    it('commits, toasts, and navigates to the new feed', async () => {
      ...
      expect(mocks.toast).toHaveBeenCalledWith({ title: 'Created My Feed' });
  ...
  describe('submit — edit navigation', () => {
    ...
    it('stays put for a presentation-only edit that keeps the id', async () => {
      ...
      expect(mocks.replace).not.toHaveBeenCalled();
      expect(mocks.toast).toHaveBeenCalledWith({ title: 'Edited Renamed' });
    });
  });
  ...
  describe('deleteFeed', () => {
    ...
    it('deletes and sends you home when you were on the deleted feed', async () => {
      ...
      expect(mocks.toast).toHaveBeenCalledWith({ title: 'Deleted Bitcoin News' });
