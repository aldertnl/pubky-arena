...
ENV NEXT_PUBLIC_DEFAULT_HTTP_RELAY="APP_PLACEHOLDER_NEXT_PUBLIC_DEFAULT_HTTP_RELAY"
ENV NEXT_PUBLIC_HOMEGATE_URL="APP_PLACEHOLDER_NEXT_PUBLIC_HOMEGATE_URL"
ENV NEXT_PUBLIC_PKARR_RELAYS="APP_PLACEHOLDER_NEXT_PUBLIC_PKARR_RELAYS"
ENV NEXT_PUBLIC_CDN_URL="APP_PLACEHOLDER_NEXT_PUBLIC_CDN_URL"
ENV NEXT_PUBLIC_HOMESERVER="APP_PLACEHOLDER_NEXT_PUBLIC_HOMESERVER"
ENV NEXT_PUBLIC_NEXUS_URL="APP_PLACEHOLDER_NEXT_PUBLIC_NEXUS_URL"
