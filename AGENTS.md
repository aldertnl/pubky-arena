...
- Only PostApplication, UserApplication, NotificationApplication may call other Applications (max depth 1, no cycles)
...
- `src/components/` changes → `docs/components.md`, `docs/z-index.md`, `docs/component-testing.md`
