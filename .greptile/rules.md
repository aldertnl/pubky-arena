...
- `fetch*` — read from network, update local
...
// GOOD
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Nexus returns untyped JSON; normalised in PostPipe.normalizeFromNexus
const data: any = response.body;
```
